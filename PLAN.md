...
- Постоянный TikTok-диспетчер хранит попытки и глобальную паузу в SQLite, выдерживает настраиваемый интервал между
  публикациями, ограничивает их число в скользящем окне 24 часа и после `spam_risk_too_many_posts` блокирует новые
  попытки на настраиваемые 24 часа. Ограничение и пауза переживают перезапуск приложения.
