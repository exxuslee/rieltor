...
window.PROPERTIES = [
  ...
  {
    id: 'rc-olymp', category: 'new-buildings', title: 'ЖК «Олімп»',
    location: 'Ірпінь', price: 850, pricePrefix: 'від ', priceSuffix: ' $/м²', rooms: 1, area: 38, floor: 'варіанти планувань', year: 0,
  ...
  {
    id: 'rc-city-park-2', category: 'new-buildings', title: 'ЖК «City Park 2»',
    location: 'Ірпінь', price: 600, pricePrefix: 'від ', priceSuffix: ' $/м²', rooms: 1, area: 35, floor: 'варіанти планувань', year: 0,
    image: 'images/properties/new-building.png',
    description: 'Новобудова для тих, хто шукає квартиру поруч із міською інфраструктурою. Підберемо актуальне планування.'
  },
  {
    id: 'rc-central-2', category: 'new-buildings', title: 'ЖК «Центральний-2»',
    location: 'Ірпінь, центр', price: 800, pricePrefix: 'від ', priceSuffix: ' $/м²', rooms: 2, area: 55, floor: 'варіанти планувань', year: 0,
    image: 'images/properties/new-building.png',
    description: 'Варіанти квартир у центральній частині міста. Доступність конкретних поверхів і ціну підтвердимо за запитом.'
  },
  {
    id: 'rc-chehov-park', category: 'new-buildings', title: 'ЖК «Chehov Парк Квартал»',
    location: 'Ірпінь, район Центрального парку', price: 750, pricePrefix: 'від ', priceSuffix: ' $/м²', rooms: 2, area: 56, floor: 'варіанти планувань', year: 0,
    image: 'images/properties/new-building.png',
    description: 'Житловий комплекс у парковому районі. Допоможемо порівняти формати квартир та підібрати зручний поверх.'
  },
  {
    id: 'rc-molodist', category: 'new-buildings', title: 'ЖК «Молодість»',
    location: 'Ірпінь', price: 750, pricePrefix: 'від ', priceSuffix: ' $/м²', rooms: 1, area: 40, floor: 'варіанти планувань', year: 0,
    image: 'images/properties/new-building.png',
    description: 'Сучасний квартал із квартирами різної площі. Зверніться, щоб отримати актуальні варіанти та умови.'
  },
  {
    id: 'rc-synergia-city', category: 'new-buildings', title: 'ЖК «Синергія Сіті»',
    location: 'Ірпінь', price: 750, pricePrefix: 'від ', priceSuffix: ' $/м²', rooms: 2, area: 60, floor: 'варіанти планувань', year: 0,
    image: 'images/properties/new-building.png',
    description: 'Новобудова з вибором сімейних і компактних планувань. Актуальний список пропозицій формується індивідуально.'
  },
  {
    id: 'rc-syayvo-2', category: 'new-buildings', title: 'ЖК «Сяйво-2»',
    location: 'Ірпінь', price: 550, pricePrefix: 'від ', priceSuffix: ' $/м²', rooms: 1, area: 34, floor: 'варіанти планувань', year: 0,
    image: 'images/properties/new-building.png',
    description: 'Добірка доступних за стартовою ціною квартир. Перевіримо наявність і відповідність вашому бюджету.'
  },
  {
    id: 'rc-sky-2', category: 'new-buildings', title: 'ЖК «Sky-2»',
    location: 'Ірпінь', price: 555, pricePrefix: 'від ', priceSuffix: ' $/м²', rooms: 1, area: 36, floor: 'варіанти планувань', year: 0,
    image: 'images/properties/new-building.png',
    description: 'Варіанти в новому комплексі для проживання або інвестиції. Уточніть планування, яке підходить саме вам.'
  },
  {
    id: 'rc-irpin-city', category: 'new-buildings', title: 'ЖК «Irpin City»',
    location: 'Ірпінь', price: 566, pricePrefix: 'від ', priceSuffix: ' $/м²', rooms: 2, area: 52, floor: 'варіанти планувань', year: 0,
    image: 'images/properties/new-building.png',
  ...
  {
    id: 'house-mezhyrichchia', category: 'houses', title: 'Будинок у котеджному містечку',
    location: 'КМ «Межиріччя»', price: 109000, pricePrefix: 'від ', rooms: 4, area: 152, floor: '2 поверхи', year: 2022,
    image: 'images/properties/house-bucha.png',
  ...
  {
    id: 'townhouse-lisne', category: 'houses', title: 'Таунхаус у котеджному містечку',
    location: 'Бучанський район', price: 70000, pricePrefix: 'від ', rooms: 3, area: 100, floor: '2 поверхи', year: 2016,
    image: 'images/properties/house-bucha.png',
