...
class SiteFooter extends HTMLElement {
    connectedCallback() {
      ...
      <div class="footer-bottom"><a href="${siteUrl('statistics.html')}">© ${new Date().getFullYear()} Ірина Ліннік</a><button class="raw-text-toggle" type="button" aria-pressed="false" aria-label="Показати вихідний текст оголошень">Вебзастосунок Rieltor</button></div>
    </div></footer>`;
...
window.propertyCard = function (property) {
    ...
    const telegramDate = Listings.telegramDate(property);
